...
public class HomebankingApplication {
    ...
    public CommandLineRunner initData(ClientRepository clientRepository , AccountRepository accountRepository , TransactionRepository transactionRepository)  {
        ...
        return (args) ->
        {
            ...
            Client client1 = new Client("Cristian", "Perez", "cristian.perez@ducit.com.ar");
            Client client2 = new Client("Melba", "Morel", "Melba.morel@mindhub.com.ar");

            clientRepository.save(client1);
            clientRepository.save(client2);

            Account cuenta1 = new Account("Cuenta 1", LocalDateTime.now(), 5000 );
            Account cuenta2 = new Account("Cuenta 2", LocalDateTime.now().plusDays(1), 7500);
            Account account3 = new Account("Cuenta 3", LocalDateTime.now(), 9000);
            Account account4 = new Account("Cuenta 4", LocalDateTime.now().plusDays(1), 6500);
